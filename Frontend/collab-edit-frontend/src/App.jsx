...
//       .then(() => {
//         setShareStatus("Workspace link copied");
//       })
//       .catch(() => {
...
//         // so rapid clicks don't stack timeouts.
...
//     const filename = `workspace-${id}.txt`;

//     downloadTextFile(text, filename);
//   }, [id]);

//   // Clean up the timer on unmount so it never fires into a dead component.
//   useEffect(() => {
...
//   // Single source of identity for this session
//   const [identity, setIdentity] = useState(() => getOrCreateIdentity());

//   // Awareness map: userId → { name, color, cursor }
//   // Local user is injected from identity (no duplicate identity creation)
...
//       // fetch(`https://sphere-motocross-hunchback.ngrok-free.dev/${id}`, {
//       //   headers: {
...
//   const handleAwarenessUpdate = useCallback((awarenessState) => {
//     const { userId, name, color, cursor, disconnected } = awarenessState;
...
//       ...prev,
//       [userId]: {
//         ...(prev[userId] ?? {}), // fixes unsafe overwrite / undefined spread issue
//         name,
//         color,
//         cursor,
//       },
...
//   if (updates === null) return <div>Loading...</div>;
...
//     // fetch("https://sphere-motocross-hunchback.ngrok-free.dev/", {
//     //   headers: {
//     //     "ngrok-skip-browser-warning": "69420", // Bypasses the ngrok interstitial page
//     //   },
//     // })
...
//   // Shared style for all toolbar buttons — keeps them visually consistent.
//   toolbarButton: {
//     padding: "6px 12px",
//     fontSize: "13px",
//     cursor: "pointer",
...
//   // Wraps the Share button and its inline feedback label together
//   // so the label never pushes the Download button around.
//   shareGroup: {
//     display: "flex",
//     alignItems: "center",
//     gap: "8px",
